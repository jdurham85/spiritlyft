...
<div data-role="page" id="sidemenu">
        ...
        <div><a href="m_myprofile.php"><button><img src="<?php echo MemberMainProfilePic($_SESSION['SessionMemberID']); ?>" /><span class="button_lb">My Profile</span><span class="button_lb" id="myprofile_alert_lb"></span></button></a></div>
