...
<div id="mainmenu">
	...
	<div><a target="_parent" href="app_home.php" data-role="button" data-transition="fade" data-ajax="false"><img src="image/home-512.png" style="" />Home</a></div>
	<div><a target="_parent" href="app_myprofile.php" data-role="button"  data-ajax="false"><img src="<?php echo MemberMainProfilePic($_SESSION['SessionMemberID']); ?>" style="" />My Profile</a></div>
	<div><a target="_parent" href="app_giftshop.php" data-role="button"><img src="image/vgift_icon.png" /><span class="button_lb">GiftShop</span><span class="button_lb" id="gift_alert_lb"></span></a></div>
	<div><a target="_parent" href="app_calender.php" data-role="button"  data-ajax="false"><img src="image/calendar_icon.png" style="" />Calendar</a></div>
	<div><a target="_parent" href="app_community.php" data-role="button"  data-ajax="false"><img src="image/friend_request_icon.png" style="" /><span class="" id="connection_alert_lb"></span>My Friends & Family</a></div>
	<div><a target="_parent" href="app_search.php" data-role="button"  data-ajax="false"><img src="image/search-icon-png-9985.png" style="" /><div style=""></div>Search</a></div>
	<div><a target="_parent" href="app_private_chat.php" data-role="button"  data-ajax="false"><img src="image/chat_icon.png" style="" /><span id="message_alert_lb"></span>Private Chat</a></div>
	...
	<div><a target="_parent" alt="Logout" href="app_logout.php" data-role="button"  data-transition="fade" data-ajax="false">
