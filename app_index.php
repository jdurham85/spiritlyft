...
{
	header("location: https://www.spiritlyft.com/app_index.php");
	exit();
}
...
<script type="text/javascript">
	function loginpage()
	{
		window.location = "app_login.php";
	}
	
	function createaccountpage()
	{
		window.location = "app_createaccount.php";	
	}
...
<header>
	...
	<div id="body" style="width:80%;">
        ...
        <!--button class="button_style1" onclick="showToast();">Test</button-->
